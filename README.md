...
- 🕌 [Muslim Prayer Reminder](https://github.com/tareq7/muslim-prayer-mcp) - Production-ready Muslim prayer reminder system on Cloudflare Workers with Streamable HTTP MCP and deterministic host middleware.
